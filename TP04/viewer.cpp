...
void Viewer::createShaders() {
  ...
  // ******************************
  _vertexFilenames.push_back("shaders/gouraudl.vert");
  _fragmentFilenames.push_back("shaders/gouraudl.frag");
...
void Viewer::enableShader(unsigned int shader) {
  ...
  glUniform3fv(glGetUniformLocation(id,"lightDir"),1,(float*)&(_light));
}
